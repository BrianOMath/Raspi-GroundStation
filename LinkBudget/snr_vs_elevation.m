...
% Cascaded noise figure (Friis) — mast-mounted LNA, ~1 m coax before it,
% ~4 m coax after it (post-LNA loss suppressed by LNA gain):
...
% -------------------------------------------------------------------------
% Received Power = EIRP - FSPL - L_total + G_rx - L_coax_pre (post-LNA loss
%   affects signal and noise equally, so it does not change C/N; its effect is
%   already captured in the cascaded noise figure)
% C/N0 = Pr - k_B - T_sys
% Margin = C/N0 - C/N0_required

% Received power at each elevation angle
Pr_dBW = EIRP_dBW - FSPL_dB - L_total_dB + G_rx_dBi - L_coax_pre_dB;
